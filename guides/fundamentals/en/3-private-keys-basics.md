...
For instance, when creating the wallet on [SendChain wallet](https://sendchain.biz) the user gets a single private key for all cryptocurrencies supported by a wallet.
